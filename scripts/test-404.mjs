...
assert.match(worker, /const CURRENT_CACHE_NAME = 'museum-of-almost-v43-unbuilt-room'/);
...
console.log('Unbuilt Room 404 recovery, path non-disclosure, self-contained rendering, accessibility, privacy, and offline fallback contract verified.');
