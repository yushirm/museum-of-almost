...
assert.match(source, /const CURRENT_CACHE_NAME = 'museum-of-almost-v43-unbuilt-room'/);
for (const asset of [
  './',
  './index.html',
  './404.html',
...
console.log('Unbuilt Room v43, Unequal Minute v42, Shutter Cabinet v41, Page Four Instrument Room v40, Catalogue 0 v39, Quorum Gate v38, Evidence Lattice v36, Signal Anomaly v35, Gauge Bench v34, Shuffle Table v37, and the existing galleries are present in the fresh-online cached-offline shell.');