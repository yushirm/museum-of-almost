...
for (const asset of [
  ...
  './world-map.css', './world-map.svg', './difference-engine.css', './field-sheet.css', './cosmic-signal.css', './cosmic-signal-core.js', './cosmic-signal-view.js',
  './cosmic-latency-core.js', './cosmic-latency.js', './cosmic-latency.css', './cosmic-escapement-core.js', './cosmic-escapement.js', './cosmic-escapement.css',
  './planetary-heliodon-core.js', './planetary-heliodon.js', './planetary-heliodon.css', './faultline-core.js', './faultline.js',
  './witness-seal-core.js', './witness-seal.js', './witness-seal.css', './isolation-board-core.js', './isolation-board.js', './isolation-board.css',
  './exposure-plate-core.js', './exposure-plate.js', './exposure-plate.css', './data-core.js', './temporal-sounding-core.js', './temporal-sounding.js', './app.js', './cosmic-signal.js',
  './deep-space.html', './deep-space.css', './deep-space-core.js', './deep-space.js', './possibility-engine.css', './possibility-engine-core.js', './possibility-engine.js',
  './frame-shifter.css', './frame-shifter-core.js', './frame-shifter.js', './almost-online.html', './web1.css', './web1.js',
  ...
  './manifest.webmanifest', './PRIVACY.md', './SOURCES.md', './SAMPLE_AND_HOLD.md', './SOUNDING_WELL.md', './FAULTLINE_CORE.md', './WITNESS_SEAL.md',
  './ISOLATION_BOARD.md', './EXPOSURE_PLATE.md', './COSMIC_RECEIVE_DESK.md', './CELESTIAL_ESCAPEMENT.md', './PLANETARY_HELIODON.md', './DEEP_SPACE.md',
  './POSSIBILITY_ENGINE.md', './FRAME_SHIFTER.md', './WEB1_HOME.md'
