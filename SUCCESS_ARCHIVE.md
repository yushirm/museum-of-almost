...
## 2026-08-08 — DEEP SPACE / ALMOST — The Possibility Engine
...
- Concept A, **The Evidence Ladder**, supplied the conventional observation-to-constraint structure but was discarded as the least additive to the existing gallery grammar.
- Concept B, **The Falsification Chamber**, supplied the laboratory and fault-isolation mechanic for applying fixed evidence to a possibility map.
- Concept C, **The Museum Keeps Only Successful Failures**, supplied the convention-breaking archive organized by productive revision rather than chronology.
- Concepts B and C were merged.

Feature-complete evidence head:

`9eab37322f936079645fbe229a5bdb64b67d8da8`

Pull request:

`#51 — Add Deep Space possibility engine`
...
- three fixed historical cases rendered as local possibility maps and static Success Archives;
- categorical `open`, `pressured`, `retired`, and `survived` states kept explicitly separate from probabilities or confidence scores;
- deterministic evidence application without mutating the fixed archive records;
...
- readable static archive material when JavaScript is unavailable;
- responsive, reduced-motion, increased-contrast, and print handling;
- coherent same-origin offline-shell upgrade preserving the Witness Seal release assets.
